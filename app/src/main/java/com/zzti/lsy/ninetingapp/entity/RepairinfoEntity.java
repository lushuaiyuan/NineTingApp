...
public class RepairinfoEntity implements Serializable {
    ...
    private String repairMoney;//维修费用
    private String repairAllMoney;//维修费用总计
    private String vehicleTypeID;//车辆类型
    ...
    private String repairFactory;//维修厂商
    ...
    public String getRepairAllMoney() {
        return repairAllMoney;
    }

    public void setRepairAllMoney(String repairAllMoney) {
        this.repairAllMoney = repairAllMoney;
    }
